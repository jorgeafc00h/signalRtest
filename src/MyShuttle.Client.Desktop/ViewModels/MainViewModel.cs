...
namespace MyShuttle.Client.Desktop.ViewModels
{
    public class MainViewModel : BaseViewModel
    {
        ...
        public MainViewModel(IMyShuttleClient myShuttleClient, DetailsViewModel details)
        {
            ...
            Bridge.ConnectTohub(AddMOdelToCollection);

        }

        private void AddMOdelToCollection(string title, string content)
        {
            if (Vehicles == null) Vehicles = new ObservableCollection<Vehicle>();
        ...
        private ConnectionBridge Bridge = null;
